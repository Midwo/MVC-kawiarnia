    ...
    public class ReviewsInictializer : CreateDatabaseIfNotExists<ReviewContext>
    {
        protected override void Seed(ReviewContext context)
        {
            ...
            var Review = new List<Reviews>
            {
                ...
                new Reviews { Name = "Darek",  ReviewText = "Laoreet ac, aliquam sit amet justo nunc tempor, metus vel placerat suscipit, orci nisl iaculis eros, a tincidunt nisi odio eget lorem nulla condimentum tempor mattis ut vitae feugiat augue cras ut metus a risus iaculis scelerisque eu ac ante fusce non.", RatingMealsId = 4,  RatingEmployeesId = 5, RatingPlaceId = 5} ,
                new Reviews { Name = "Ania",  ReviewText = "Laoreet ac, aliquam sit amet justo nunc tempor, metus vel placerat suscipit, orci nisl iaculis eros, a tincidunt nisi odio eget lorem nulla condimentum tempor mattis ut vitae feugiat augue cras ut metus a risus iaculis scelerisque eu ac ante fusce non.", RatingMealsId = 3,   RatingEmployeesId = 4, RatingPlaceId = 4} ,
                new Reviews { Name = "Kasia",  ReviewText = "Laoreet ac, aliquam sit amet justo nunc tempor, metus vel placerat suscipit, orci nisl iaculis eros, a tincidunt nisi odio eget lorem nulla condimentum tempor mattis ut vitae feugiat augue cras ut metus a risus iaculis scelerisque eu ac ante fusce non.", RatingMealsId = 2, RatingEmployeesId = 3, RatingPlaceId = 5} ,
            };
